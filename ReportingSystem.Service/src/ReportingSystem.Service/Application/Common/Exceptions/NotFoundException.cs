...
/// <summary>
/// Represents an exception that occurs when a specific requested entity is not found.
/// This exception is typically caught by middleware and translated into an HTTP 404 Not Found response.
/// </summary>
public class NotFoundException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NotFoundException"/> class with a formatted message for a specific entity and key.
    /// </summary>
